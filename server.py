...
from models import schooluder_model, fun_tasks_model, upload_task_model, upload_fun_task_model, login_model, task_model, people_model
import datetime
import smtplib
...
def about_fun_tasks():
    ...
    return render_template('fun_task.html', student_class = student_class, fun_tasks = fun_tasks, fun_tasks_1=fun_tasks_1, fun_tasks_2=fun_tasks_2)
